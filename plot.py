...
# values = [10, 40, 60, 80, 100, 120, 140, 160, 180, 200, 240, 300]
#
# for k in values:
#     with open('./build/fingering/block/1024/G10k' + str(k) + '.txt', 'r') as f:
#         z1 = [[float(num) for num in line.split()] for line in f]
#
#
#     z1 = np.array(z1)
#     z1 = z1.reshape(1024, 1024)
#
#     fig = plt.imshow(z1, interpolation = 'bicubic')
#     fig.axes.get_xaxis().set_visible(False)
#     fig.axes.get_yaxis().set_visible(False)
#     plt.title(r'$G = 10, N = 1024, k =' + str(k) + '$')
#     plt.savefig("../results_new/fingering/block/1024/G10k" + str(k) + ".pdf")
